...
--			Schools={ } },
	...
	["PALADIN"] = {
		...
		{ id="Holy Light", level1=1, level2=6, level3=14, percent=2.5/3.5, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy" } },
		{ id="Exorcism", percent=1.5/2.8, dodps=1, cancrit=1, dontdomax=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Wrath", percent=2/3.5/3, dodps=1, cancrit=1, aoe=1, dontdomax=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Consecration", percent=3.5/2.9, dodps=1, aoe=1, basedotduration=8, dontdomax=1, isdot=1,
			Schools={ "All", "Damage", "Holy" } },
		...
		{ id="Seal of Righteousness", isseal=1, percent=0.1, percent2=0.41, percentdot=1.2, hasdot=1, righteousness=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Shock", percent=1.5/2.5, percentheal=1.5/3.5, cancrit=1, holynova=1, dontdomax=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
